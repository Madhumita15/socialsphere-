        ...
        <DialogContent className="sm:max-w-sm bg-gray-950 border border-gray-800 text-white shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                disabled={action === "edit" || creatingPending}
            ...
            <DialogFooter className="flex gap-3 pt-4 bg-slate-900 border-t border-gray-900">
              <DialogClose className="inline-flex h-9 cursor-pointer items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors bg-gray-800 border border-gray-700 text-white hover:bg-gray-700 hover:text-white focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50">
                Cancel
              </DialogClose>
              ...
              <Button
                ...
                className="bg-linear-to-r cursor-pointer from-[#3a170c] to-orange-500 hover:from-[#FF7354] hover:to-orange-950 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
