    ...
    >
      ...
      <div className="absolute right-0 bottom-20 sm:bottom-20 md:bottom-24 z-10 flex flex-col gap-4 sm:gap-5 md:gap-6 pr-2 sm:pr-3 md:pr-4 pb-2 sm:pb-3 md:pb-4">
        ...
        <div className="flex flex-col items-center gap-1.5">
          ...
          >
            <Heart
              className={`h-5 w-5 sm:h-6 sm:w-6 md:h-9 md:w-9 text-white ${user_has_liked ? "fill-red-600" : "fill-white"} `}
            />
          </Button>
        ...
        <div className="flex flex-col items-center gap-1.5">
          <Button
            onClick={(e) =>
              handleShare(e, { id: id, authorName: authorName, type: "video" })
            }
            variant="ghost"
            size="icon"
        ...
        <div className="flex flex-col items-center gap-1.5">
          <Button
            ...
            variant="ghost"
            size="icon"
            className="rounded-full cursor-pointer h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 hover:scale-110 transition-transform bg-black/40 hover:bg-black/60"
          >
            <Bookmark
              className={`h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 text-white ${isSaved ? "fill-red-600" : "fill-white"}`}
            />
          </Button>
        </div>
      </div>
